...
<tr><th>S.NO</th><th>Question</th><th>Correct&nbsp;Answer</th><th>User&nbsp;Answer</th></tr>
<%
	...
	while(rs.next())
	{
		count=count+1;
		 Statement stmt = con.createStatement();
			ResultSet rs1=stmt.executeQuery("select * from questionslist where id='"+rs.getString("qid")+"' ");
		if(rs1.next())
		{
			...
			%>
			<tr><td><%=count%></td><td><%=rs1.getString("question") %></td><td><%=ans1 %></td><td><%=ans %></td></tr>
			<%
		}
	}
	con.close();
...
%>
<tr><td colspan="4">Total Correct Answers <%=cans %></td></tr>
</table>
</body>
</html>